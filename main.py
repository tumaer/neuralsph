...
def load_embedded_configs(config_path: str, cli_args: DictConfig) -> DictConfig:
    ...
    while "extends" in cfgs[0]:
        ...
        if extends_path != "NEURALSPH_DEFAULTS":
    ...
    # assert that the cli_args are a subset of the defaults.
...
if __name__ == "__main__":
    ...
    # values that need to be specified before importing jax_md
    ...
    from neural_sph.runner import train_or_infer
