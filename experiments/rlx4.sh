#!/bin/bash
# nohup bash experiments/rlx4.sh >> experiments/rlx4.out 2>&1 &

GPU=4

### pretrained checkpoint
python main.py config=experiments/rlx.yaml gpu=$GPU r.acc=0.0

RLT_DIR="rlt/rlx_ldc2d/gns_ldc2d_20240328-220101"

run_basic() {
    python main.py gpu=$GPU load_ckp=ckp/rlx_ldc2d/gns_ldc2d_20240328-220101 \
