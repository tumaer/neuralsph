#!/bin/bash
# nohup bash experiments/rlx5.sh >> experiments/rlx5.out 2>&1 &
...
RLT_DIR="rlt/rlx_ldc2d/gns_ldc2d_20240328-220116"

run_basic() {
    python main.py gpu=$GPU load_ckp=ckp/rlx_ldc2d/gns_ldc2d_20240328-220116 \
