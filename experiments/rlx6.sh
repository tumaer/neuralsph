#!/bin/bash
# nohup bash experiments/rlx6.sh >> experiments/rlx6.out 2>&1 &
...
RLT_DIR="rlt/rlx_ldc2d/gns_ldc2d_20240328-220201"

run_basic() {
    python main.py gpu=$GPU load_ckp=ckp/rlx_ldc2d/gns_ldc2d_20240328-220201 \
