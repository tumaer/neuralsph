#!/bin/bash
# nohup bash experiments/rlx2.sh >> experiments/rlx2.out 2>&1 &

GPU=2

### pretrained checkpoint
python main.py config=experiments/rlx.yaml gpu=$GPU r.acc=0.02

RLT_DIR="rlt/rlx_ldc2d/gns_ldc2d_20240328-220043"

run_basic() {
    python main.py gpu=$GPU load_ckp=ckp/rlx_ldc2d/gns_ldc2d_20240328-220043 \
